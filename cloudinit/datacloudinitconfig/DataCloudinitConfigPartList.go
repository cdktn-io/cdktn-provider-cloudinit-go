...
func (j *jsiiProxy_DataCloudinitConfigPartList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudinitConfigPartList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudinitConfigPartList {
	_init_.Initialize()
...
func NewDataCloudinitConfigPartList_Override(d DataCloudinitConfigPartList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudinitConfigPartList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudinitConfigPartList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudinitConfigPartList) Resolve(context cdktn.IResolveContext) interface{} {
